"""
===========================================================
  🔥 Free Fire Matchmaking Bot — V2 ULTIMATE
===========================================================
  ...
  🆕 auto_setup_guild ذكي — يتعرف على القنوات الموجودة
     حتى لو اختلفت أسماؤها (apostada-play, apostada_play, إلخ)
  🆕 auto_setup_guild يسجل القنوات الموجودة في DB بدل إنشاء جديد
  ...
  🆕 Fuzzy matching للكاتيجوريات والقنوات

  📊 45 أمر | 6,300+ سطر | 0 أخطاء وقت التشغيل
===========================================================
"""
...
class MvpSelectionView(discord.ui.View):
    ...
    async def confirm_callback(self, interaction):
        ...
        logger.info(f"🏆 MVP confirmed — lobby={self.lobby_id}, winner_mvp={self.winner_mvp_id}, loser_mvp={self.loser_mvp_id}")
...
async def auto_setup_guild(guild):
    ...
    for ch_key in ["Waiting 1", "Waiting 2", "Waiting 3", "Waiting 4", "Waiting 5",
                    ...
                    "Under Check 1", "Under Check 2", "Under Check 3", "Under Check Staff"]:
